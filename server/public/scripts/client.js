...
function CalendarCtrl($scope, $http) {
    ...
    //event source that pulls from <a class="vglnk" href="http://google.com" rel="nofollow"><span>google</span><span>.</span><span>com</span></a>
    // $scope.eventSource = {
    //         url: "<a class="vglnk" href="http://www.google.com/calendar/feeds/usa__en%40holiday.calendar.google.com/public/basic" rel="nofollow"><span>http</span><span>://</span><span>www</span><span>.</span><span>google</span><span>.</span><span>com</span><span>/</span><span>calendar</span><span>/</span><span>feeds</span><span>/</span><span>usa</span><span>__</span><span>en</span><span>%</span><span>40holiday</span><span>.</span><span>calendar</span><span>.</span><span>google</span><span>.</span><span>com</span><span>/</span><span>public</span><span>/</span><span>basic</span></a>",
    ...
    $scope.events = [
      ...
      {title: 'Click for Google',start: new Date(y, m, 28),end: new Date(y, m, 29),url: '<a class="vglnk" href="http://google.com/" rel="nofollow"><span>http</span><span>://</span><span>google</span><span>.</span><span>com</span><span>/</span></a>'}
    ];
